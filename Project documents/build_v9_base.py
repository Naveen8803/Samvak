...
# Start deleting when we see 'ABSTRACT' standing alone or similar
elements = list(doc._element.body)
delete_flag = False
for child in elements:
    ...
    if delete_flag:
        ...
        # Check if text is ABSTRACT
        txt = "".join(child.itertext()).strip()
        if txt == 'ABSTRACT' or txt == 'ABSTRACT ':
            delete_flag = True
            child.getparent().remove(child)

doc.save(r'E:\sam\Project documents\Samvak_Base_Clean_V2.docx')
print("Cleaned base generated.")
